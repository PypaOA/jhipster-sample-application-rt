...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).surName(DEFAULT_SUR_NAME).money(DEFAULT_MONEY);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).surName(UPDATED_SUR_NAME).money(UPDATED_MONEY);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getMoney()).isEqualTo(DEFAULT_MONEY);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).surName(UPDATED_SUR_NAME).money(UPDATED_MONEY);
        ...
        assertThat(testCustomer.getMoney()).isEqualTo(UPDATED_MONEY);
    }
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).surName(UPDATED_SUR_NAME).money(UPDATED_MONEY);
