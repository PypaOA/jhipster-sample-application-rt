...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().name(DEFAULT_NAME).date(DEFAULT_DATE).price(DEFAULT_PRICE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().name(UPDATED_NAME).date(UPDATED_DATE).price(UPDATED_PRICE);
        return order;
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.name(UPDATED_NAME).date(UPDATED_DATE).price(UPDATED_PRICE);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.name(UPDATED_NAME).price(UPDATED_PRICE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.name(UPDATED_NAME).date(UPDATED_DATE).price(UPDATED_PRICE);
