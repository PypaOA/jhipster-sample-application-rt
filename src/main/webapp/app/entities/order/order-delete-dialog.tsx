...
export const OrderDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationReactTestApp.order.delete.question">
        <Translate contentKey="jhipsterSampleApplicationReactTestApp.order.delete.question" interpolate={{ id: orderEntity.id }}>
