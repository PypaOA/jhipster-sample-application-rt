...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationReactTestApp.customer.delete.question">
        <Translate contentKey="jhipsterSampleApplicationReactTestApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
